...
<div id="dialog" class="animated">
    ...
    {{ csrf_field() }}
        <ul class="editInfos">
            ...
            <li><label><font color="#ff0000">* </font>昵称：<input  required value="{{$ufirst->nickname}}" class="ipt" name="nickname" /></label></li>
            <li><label><font color="#ff0000">* </font>密码：<input type="text" name="password" required  class="ipt" /></label></li>
